module.exports = {
	ERRORS: {
		...
		email_verification: 'First you have to approve you email. We have sent verification link to your email',
		not_verifyed: 'Error: This email is not approved yet',
